function [X,y,Xtest,Ytest] = joelPRNG(n,d,t,k,featureType, labelSize)
%n - number of inputs
...
if(k ~= 2)
    error('Not a supported value for k. Only values of 2 are supported for joelPRNG.');
end

[numsTrain, numsTest] = loadPRNG('joel',n,d,t,k);
